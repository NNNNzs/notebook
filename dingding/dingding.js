...
class DingDing {
    constructor(accessToken) {
        ...
        this.accessToken = '517a1d82345d320a93c44c30a4522caa';
...
class DingDingDept extends DingDing {
    async getDeptIdByParent(parentId = '1') {
        ...
        let res = await axios({
            ...
            params: { access_token: this.accessToken, id: parentId }
        });
        return res.data;
    }
}
class Message extends DingDing {
    async getSendProgress(task_id) {
        ...
        let res = await axios({
            ...
            data: { agent_id: this.agentId, task_id: task_id },
            method: 'post',
        });
        return res.data;
    }
    ...
    async sendText() {
        ...
        let res = await axios({
            ...
            data: {
                ...
                msg: {
                    // "msgtype": "text", "text": { "content": "容asdasdasd呵呵asdsd呵呵" },
                    "msgtype": "oa",
                    "oa": {
